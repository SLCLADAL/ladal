...
Too get in touch with us here at LADAL, you can simply write an email to **ladal\@uq.edu.au**, reach out to us on Twitter (\@slcladal), send us a message on Facebook (see our  [**Facebook** page](https://www.facebook.com/profile.php?id=100073328753218) or you can sign up to the LADAL email list. To subscribe to our email list,  simply write an email to **ladal@uq.edu.au** with the subject **email list**.
...
![](/images/happycomputer.png){ width=30% style="float:right; padding:15px" }
...
![](/images/consult.jpg){ width=40% style="float:right; padding:5px" }
