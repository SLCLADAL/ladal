...
Vowel Chart of monophthongal vowel sounds in Received Pronunciation (RP) (left); Tongue positions for the vowels /i, e, E, a/ (right)
...
![](/images/praatrecording1.png){#fig-praatrecording1}

Praat's main object window

:::


::: {#fig-praatrecodingwindow}

![](/images/praatrecodingwindow.png){#fig-praatrecodingwindow}

Praat's recording window
...
![](/images/praatrecording2.png){#fig-praatrecording2}

Praat's recording window during recording

:::

::: {#fig-praatrecordingclose}

![](/images/praatrecordingclose.png){#fig-praatrecordingclose}

Praat's recording window after recording
...
::: {#fig-praatrecordingsaved}

![](/images/praatrecordingsaved.png){#fig-praatrecordingsaved}

Praat's main object window with saved object
...
![](/images/praatrecordingedit1.png "Figure 9: Praat's edit window with the word *heed* repeated three times"){ width=75% style="float:center; padding:10px" }

::: {#fig-praatrecordingedit1}

![](/images/praatrecordingedit1.png){#fig-praatrecordingedit1}

Praat's edit window with the word *heed* repeated three times
...
::: {#fig-praatrecordingedit2}

![](/images/praatrecordingedit2.png){#fig-praatrecordingedit2}

Praat's edit window with the word *heed* repeated three times and formants shown
...
![](/images/praatmarked.png){#fig-praatmarked}

Praat's edit window with the word *heed* repeated three times and formants shown and steady state selected
...
![](/images/praathz.png){#fig-praathz}

The mean Hertz frequency of first formant of the word *heed* during the steady state
