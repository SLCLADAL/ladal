...
notebook_path <- "interactive-notebooks/notebooks/oll_cb.ipynb"
...
base_url <- "https://binderhub.atap-binder.cloud.edu.au/v2/gh/SLCLADAL/interactive-notebooks-environment/main"
repo_url <- "https://github.com/SLCLADAL/interactive-notebooks"
notebook_path <- "interactive-notebooks/notebooks/amtool.ipynb"
...
Click [**here**](`r binder_url`) to open an notebook-based tool <br>that <b>calculates association measures</b> and allows you to download the results.
:::
...
Click [**here**](`r binder_url`) to open an notebook-based tool <br>that calculates association measures and allows you to download the results.
:::
