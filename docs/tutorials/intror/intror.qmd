...
The entire R Notebook for the tutorial can be downloaded [here](tutorials/intror/intror.qmd).  If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](/assets/bibliography.bib) and store it in the same folder where you store the Rmd or the Rproj file. <br></p>
...
* You have NOT yet installed **R** on your computer? 
  ...
  + You have a Windows computer? Then click [here](https://cran.r-project.org/bin/windows/base/R-4.0.2-win.exe) to download and install R.

  + You have a Mac? Then click [here](https://cran.r-project.org/bin/macosx/R-4.0.2.pkg) to download and install R.
