...
Schweinberger, Martin. `r format(Sys.time(), '%Y')`. *Introduction to Quantitative Reasoning*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tutorials/introquant.html (Version `r format(Sys.time(), '%Y.%m.%d')`).
