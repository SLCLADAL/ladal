...
Schweinberger, Martin. 2022. *Handling tables in R*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tutorials/table.html (Version 2022.11.17).
...
@manual{schweinberger2022tabr,
  ...
  title = {Handling tables in R},
  note = {tutorials/table/table.html},
  year = {2022},
