---
title: "WordFinder"
subtitle: "LADAL Keyword-in-Context Concordancing Tool"
format:
  html:
    toc: true
    toc-depth: 3
...
```
https://binderhub.rc.nectar.org.au/v2/gh/SLCLADAL/interactive-notebooks-environment/main?urlpath=git-pull%3Frepo%3Dhttps%253A%252F%252Fgithub.com%252FSLCLADAL%252Ftools%26urlpath%3Dshiny%252Ftree%252Ftools%252Fwordfinder%252F%26branch%3Dmain
```
