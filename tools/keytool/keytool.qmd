...
<b>The code chunks below calculate keyness statistics that represent how characteristic words are for a text or corpus! 
</p>
</span>
</div>
<br>
...
<span>
<p style='margin-top:1em; text-align:center'>
<b> You need to upload file(s) into both the `Target` and the `Reference` folders.</b>
<br>
Click on the folder called <b>`Target`</b> (it is in the menu to the left of the screen) and then simply drag and drop the txt-file(s) containing your target data into the folder. 
<br>
...
<span>
<p style='margin-top:1em; text-align:center'>
<b>You will find the generated MS Excel spreadsheet named *keys.xlsx* in the `MyOutput` folder (located on the left side of the screen).</b> <br><br>Simply double-click the `MyOutput` folder icon, then right-click on the *keys.xlsx* file, and choose Download from the dropdown menu to download the file.
</p>
</span>
</div>
<br>
...
<span>
<p style='margin-top:1em; text-align:center'>
<b>You will find the image-file named *image_01.png* in the `MyOutput` folder (located on the left side of the screen).</b> <br><br>Simply double-click the `MyOutput` folder icon, then right-click on the *image_01.png* file, and choose Download from the dropdown menu to download the file.
</p>
</span>
</div>
<br>
...
Schweinberger, Martin. 2025. *LADAL Keyword Tool*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tools.html (Version 2025.04.04).

```
@manual{schweinberger2025keytool,
...
[back to the LADAL tutorial on Keyword Analysis](/tutorials/key/key.html)
