...
# Convert single rmd to a ipynb

```{r convert1, eval = F, message = F}
# convert 1 notebook
rmd2jupyter::rmd2jupyter(here::here("tools/amtool/amtool.qmd"))
```

# Convert many rmd to ipynb
...
ladalrmds <- list.files(here::here("tools"), pattern = ".Rmd")
ladalrmds
```
