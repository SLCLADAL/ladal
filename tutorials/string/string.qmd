...
[**Q1**]{style="color:green;"} Load the text `linguistics04`. How many words does the text consist of?
...
```{r}
#| code-fold: true
#| code-summary: "Show code to answer Q1."
#| eval: false
...
[**Q2**]{style="color:green;"} How many characters does the text consist of?
...
```{r}
#| code-fold: true
#| code-summary: "Show code to answer Q2."
#| eval: false
