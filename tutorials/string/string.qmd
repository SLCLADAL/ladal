...
```{r binder_url, echo=FALSE, message=FALSE, warning=FALSE}
...
notebook_path <- "interactive-notebooks/notebooks/stringtool.ipynb"
repo_param    <- URLencode(paste0("repo=", URLencode(repo_url, repeated = TRUE)), repeated = TRUE)
nb_param      <- URLencode(paste0("urlpath=lab/tree/", notebook_path), repeated = TRUE)
params        <- paste0("urlpath=git-pull%3F", repo_param, "%26", nb_param, "%26branch=main")
...
Click [**here**](`r binder_url`) to open the interactive string-processing notebook.
:::
:::
