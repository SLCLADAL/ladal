...
[**Q3**]{style="color:purple;"} Load the text `linguistics04`. How many words does the text consist of?
...
```{r}
#| code-fold: true
#| code-summary: "Show code to answer Q3."
#| eval: false
...
[**Q4**]{style="color:purple;"} How many characters does the text consist of?
...
[**Q5**]{style="color:purple;"} The following text is a sentence that has undergone a common data cleaning procedure. Which of the following functions was most likely used?
