...
The entire R markdown document for the sections below can be downloaded [here](tutorials/net/net.Rmd).  If you want to render the Rmarkdown notebook on your machine, i.e. knitting the document to a html or pdf file, you need to make sure that you have R installed and you also need to download the [bibliography file](tutorials/net/bibliography.bib) and store it in the same folder where you store the Rmd file.<br><br>
