...
notebook_path <- "interactive-notebooks/notebooks/nettool.ipynb"
...
We now turn to generating *tidy networks* which is more complex but also offers more flexibility and options for customization. 
