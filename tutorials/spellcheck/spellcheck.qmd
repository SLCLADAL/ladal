...
The entire R Notebook for the tutorial can be downloaded [**here**](tutorials/spellcheck/spellcheck.Rmd).  If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](tutorials/spellcheck/bibliography.bib) and store it in the same folder where you store the Rmd file. <br><br>
...
# read in text
exampletext <- base::readRDS(url("tutorials/spellcheck/data/tx1.rda", "rb"))
# inspect
exampletext
```
