...
notebook_path <- "interactive-notebooks/notebooks/kwics_cb.ipynb"
...
Click [**here**](`r binder_url`) to open an notebook-based tool <br>that allows you to upload your own text(s), perform concordancing on them, and download the resulting kwic(s).
:::
