...
This tutorial introduces concordancing and keyword-in-context (KWIC) displays with R using the `quanteda` package [@quanteda2018package]. 

<div class="warning">
<span>
<p style='margin-top:1em; text-align:center'>
Please cite as: <br>Schweinberger, Martin. 2024. *Concordancing with R*. Brisbane: The Language Technology and Data Analysis Laboratory (LADAL). url: tutorials/kwics.html (Version 2024.05.07).<br>
</p>
</span>
</div>
...
Schweinberger, Martin. 2024. *Concordancing with R*. Brisbane: The Language Technology and Data Analysis Laboratory (LADAL). url: tutorials/kwics.html (Version 2024.05.07).
