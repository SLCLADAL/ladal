...
params:
  ...
  url:         "https://ladal.edu.au/tutorials/data_simulation/data_simulation.html"
  institution: "The Language Technology and Data Analysis Laboratory (LADAL), The University of Queensland, Australia"
  description: "This tutorial introduces data simulation in R from first principles, covering pseudo-random number generation, sampling from distributions relevant to linguistics, and the assembly of realistic synthetic datasets for a wide range of research applications. It goes beyond power analysis to demonstrate advanced simulation workflows including correlated predictors, sociolinguistic variation, missing data, longitudinal trajectories, synthetic text generation, and formal power analysis. It is aimed at researchers in quantitative linguistics and the social sciences who want to verify statistical models, create reproducible examples without distributing sensitive data, or test analysis pipelines before real data is available."
  keywords:       "data simulation, synthetic data, power analysis, pseudo-random numbers, Monte Carlo, reproducible research, statistical modelling, sociolinguistic variation, missing data, longitudinal data"
  doi:         "10.5281/zenodo.19332960"
---
...
- [Basic Inferential Statistics](/tutorials/inferential_stats/inferential_stats.html) — null hypothesis testing, p-values, effect sizes (recommended for the power analysis section)
...
If you have real data and want to learn how to import it into R, see the companion tutorial: **[Loading and Saving Data in R](/tutorials/data_loading/data_loading.html)**.
:::
...
Sociolinguistic variation research models the probability of a speaker selecting one linguistic variant over another (e.g. *going* vs. *goin'*, *t*-deletion vs. retention, copula deletion vs. retention in AAVE). The classic **Varbrul** framework [@cedergren1974variable; @sankoff1979uses] models variant probability as a function of:
