...
dir.create("tutorials/ladal_concordancing_tutorial/data", recursive = TRUE, showWarnings = FALSE)
save(rawtext, file = "tutorials/ladal_concordancing_tutorial/data/alice.rda")
```

This creates `tutorials/ladal_concordancing_tutorial/data/alice.rda`, which the tutorial loads at knit time.
:::
...
- [Loading and Saving Data in R](/tutorials/load/load.html) — reading files into R
- [String Processing in R](/tutorials/string/string.html) — working with text using `stringr`
- [Regular Expressions in R](/tutorials/regex/regex.html) — pattern matching with regex
:::
...
Schweinberger, Martin. 2026. *Finding Words in Text: Concordancing with R*. Brisbane: The Language Technology and Data Analysis Laboratory (LADAL). url: https://ladal.edu.au/tutorials/ladal_concordancing_tutorial/ladal_concordancing_tutorial.html. doi: 10.5281/zenodo.19201490 (Version 2.0.0).
:::
...
```{r binderurl, echo=FALSE, message=FALSE, warning=FALSE}
...
notebook_path  <- "interactive-notebooks/notebooks/kwictool.ipynb"
...
Click [**here**](`r binder_url`) to open the interactive concordancing notebook.
:::
:::
...
rawtext <- readRDS(here::here("tutorials/ladal_concordancing_tutorial/data/alice.rda"))   # loads object: rawtext
```
...
files <- paste0("tutorials/ladal_concordancing_tutorial/data/ICEIrelandSample/S1A-00", 1:5, ".txt")
...
# ── Load and clean text ──────────────────────────────────────
load("tutorials/ladal_concordancing_tutorial/data/alice.rda")   # loads object: rawtext
...
```
@manual{schweinberger2026ladal_concordancing_tutorial,
  author       = {Schweinberger, Martin},
  title        = {Finding Words in Text: Concordancing with R},
  note         = {tutorials/ladal_concordancing_tutorial/ladal_concordancing_tutorial.html},
  year         = {2026},
