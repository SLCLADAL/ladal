...
params:
  ...
  url:         "https://ladal.edu.au/tutorials/learner_language/learner_language.html"
  institution: "The Language Technology and Data Analysis Laboratory (LADAL), The University of Queensland, Australia"
  description: "This case study tutorial demonstrates how to analyse learner language using R, covering learner corpus compilation, error analysis, the comparison of native and non-native speaker language, statistical testing, and pedagogical applications. It is aimed at researchers in second language acquisition and applied linguistics who want to apply computational corpus methods to learner language data."
  keywords:       "learner language, learner corpus, second language acquisition, SLA, error analysis, interlanguage, applied linguistics"
  doi:         "10.5281/zenodo.19332906"
---
...
- [Introduction to Text Analysis — Part 1](/tutorials/text_analysis_intro/text_analysis_intro.html)
:::
...
ns1 <- base::readRDS("tutorials/learner_language/data/LCorpus/ns1.rda", "rb")
ns2 <- base::readRDS("tutorials/learner_language/data/LCorpus/ns2.rda", "rb")

# L2 learners (ICLE sub-corpora)
es <- base::readRDS("tutorials/learner_language/data/LCorpus/es.rda", "rb")
de <- base::readRDS("tutorials/learner_language/data/LCorpus/de.rda", "rb")
fr <- base::readRDS("tutorials/learner_language/data/LCorpus/fr.rda", "rb")
it <- base::readRDS("tutorials/learner_language/data/LCorpus/it.rda", "rb")
pl <- base::readRDS("tutorials/learner_language/data/LCorpus/pl.rda", "rb")
ru <- base::readRDS("tutorials/learner_language/data/LCorpus/ru.rda", "rb")
```
