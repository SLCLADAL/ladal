...
<p style='margin-top:1em; text-align:center'>
Click [**here**](https://ladal.edu.au/content/corplingr.Rmd)^[If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](tutorials/corplingr/bibliography.bib) and store it in the same folder where you store the Rmd file.] to download the **entire R Notebook** for this tutorial.<br><br>
...
hslld <- readRDS(url("tutorials/corplingr/data/hslld.rda", "rb"))
...
# load bio data
bio <- base::readRDS(url("tutorials/corplingr/data/d01.rda", "rb"))
```
