...
The entire R Notebook for the tutorial can be downloaded [**here**](tutorials/motion/motion.Rmd).  If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](tutorials/motion/bibliography.bib) and store it in the same folder where you store the Rmd file. <br></p>
...
# load data
coocdata <- base::readRDS(url("tutorials/motion/data/coo.rda", "rb"))
```
