...
This introduction focuses on general questions and ideas behind data visualization, including problems you may encounter and practical exercises in setting up graphs. How to create different types of plots is shown in [this tutorial](/tutorials/dviz/dviz.html).
...
Schweinberger, Martin. 2025. *Introduction to Data Visualization in R*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tutorials/introviz/introviz.html  (Version 2025.04.01).

```
@manual{schweinberger2025introviz,
