...
# load text
text <- base::readRDS(url("tutorials/textanalysis/data/alice.rda", "rb"))
```
...
# load data
orwell_sep <- base::readRDS(url("tutorials/textanalysis/data/orwell.rda", "rb"))
orwell <- orwell_sep %>%
  paste0(collapse = " ")
melville_sep <- base::readRDS(url("tutorials/textanalysis/data/melville.rda", "rb"))
melville <- melville_sep %>%
  paste0(collapse = " ")
darwin_sep <- base::readRDS(url("tutorials/textanalysis/data/darwin.rda", "rb"))
darwin <- darwin_sep %>%
  paste0(collapse = " ")
```
...
```{r}
# load data
text1 <- base::readRDS(url("tutorials/textanalysis/data/orwell.rda", "rb")) %>%
  paste0(collapse = " ")
text2 <- base::readRDS(url("tutorials/textanalysis/data/melville.rda", "rb")) %>%
  paste0(collapse = " ")
```
...
# load text
sample <- base::readRDS(url("tutorials/textanalysis/data/alice.rda", "rb")) %>%
  .[1:10] %>%
  paste0(collapse = " ")
# inspect
substr(sample, 1, 200)
