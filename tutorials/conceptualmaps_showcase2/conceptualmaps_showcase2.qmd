...
```{r fr-pdf, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r drl-pdf, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r fa2-pdf, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r umap-pdf, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r download-gml, eval=TRUE, message=FALSE, warning=FALSE}
download.file(
