...
The entire R Notebook for the tutorial can be downloaded [here](/tutorials/vc/vc.qmd).  If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](/assets/bibliography.bib) and store it in the same folder where you store the Rmd file. 
<br>
</p>
</span>
</div>
...
![Vowel Chart of monophthongal vowel sounds in Received Pronunciation (RP)](/images/vowelchartrp.png){#fig-vcrp}

![Tongue positions for the vowels /i, e, E, a/](/images/vowelstongue.png){#vtongue}
...
```{r eval = F, vcrp, echo=FALSE, out.width= "55%", fig.align = 'center', fig.cap="Figure 1: Vowel Chart of monophthongal vowel sounds in Received Pronunciation (RP) (left); Tongue positions for the vowels /i, e, E, a/ (right)", fig.show='hold',fig.align='center'}
...
![](/images/openpraat.png){ width=75% style="float:center; padding:10px" }

```{r eval = F, praatmain, echo=FALSE, out.width= "75%", fig.align = 'center', fig.cap="Figure 2: Praat's main object window (left) and Praat's picture window (right)"}
...
![](/images/praatrecording1.png "Figure 3: Praat's main object window"){ width=65% style="float:left; padding:10px" }

```{r eval = F, praatmain2, echo=FALSE, out.width= "65%", fig.align = 'center', fig.cap="Figure 3: Praat's main object window"}
knitr::include_graphics("/images/praatrecording1.png")
```


```{r eval = F, praatrec, echo=FALSE, out.width= "65%", fig.align = 'center', fig.cap="Figure 4: Praat's recording window"}
...
```{r eval = F, praatdurrec, echo=FALSE, out.width= "65%", fig.align = 'center', fig.cap="Figure 5: Praat's recording window during recording"}
knitr::include_graphics("/images/praatrecording2.png")
```


```{r eval = F, praataftrec, echo=FALSE, out.width= "65%", fig.align = 'center', fig.cap="Figure 6: Praat's recording window after recording"}
...
```{r eval = F, praatsav, echo=FALSE, out.width= "65%", fig.align = 'center', fig.cap="Figure 7: Praat's main object window with saved object"}
knitr::include_graphics("/images/praatrecordingsaved.png")
```


```{r eval = F, praatwav, echo=FALSE, out.width= "75%", fig.align = 'center', fig.cap="Figure 8: Save the recording as a .wav file"}
knitr::include_graphics("/images/praatrecording1.png")
```
...
```{r eval = F, praatheed0, echo=FALSE, out.width= "75%", fig.align = 'center', fig.cap="Figure 9: Praat's edit window with the word *heed* repeated three times"}
...
```{r eval = F, praatheed1, echo=FALSE, out.width= "75%", fig.align = 'center', fig.cap="Figure 10: Praat's edit window with the word *heed* repeated three times and formants shown"}
...
```{r eval = F, praatheed2, echo=FALSE, out.width= "75%", fig.align = 'center', fig.cap="Figure 11: Praat's edit window with the word *heed* repeated three times and formants shown and steady state selected"}
...
```{r eval = F, praatheed3, echo=FALSE, out.width= "75%", fig.align = 'center', fig.cap="Figure 12: The mean Hertz frequency of first formant of the word *heed* during the steady state"}
...
voweldata <- rbind(nns, ns) %>%
    ...
    dplyr::mutate(
        Speaker = ifelse(Speaker == "ms", "Learner", "NS"),
        ipa = case_when(
            Word == "had" ~ "\u00E6",
            Word == "hard" ~ "\u0251",
            Word == "head" ~ "e",
