...
params:
  ...
  url:         "https://ladal.edu.au/tutorials/concordancing_tutorial/concordancing_tutorial.html"
...
dir.create("tutorials/concordancing_tutorial/data", recursive = TRUE, showWarnings = FALSE)
save(rawtext, file = "tutorials/concordancing_tutorial/data/alice.rda")
```

This creates `tutorials/concordancing_tutorial/data/alice.rda`, which the tutorial loads at knit time.
:::
...
rawtext <- readRDS(here::here("tutorials/concordancing_tutorial/data/alice.rda"))   # loads object: rawtext
```
...
files <- paste0("tutorials/concordancing_tutorial/data/ICEIrelandSample/S1A-00", 1:5, ".txt")
...
# ── Load and clean text ──────────────────────────────────────
load("tutorials/concordancing_tutorial/data/alice.rda")   # loads object: rawtext
