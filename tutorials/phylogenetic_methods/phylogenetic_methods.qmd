...
params:
  ...
  description:       "This showcase tutorial demonstrates genealogically-sensitive statistical methods for linguistic typology in R, covering the ACL and BM methods for computing phylogenetically-weighted proportions and averages, constructing and manipulating linguistic family trees with glottoTrees, and a complete worked example reproducing a published typological study across 496 languages. It is aimed at researchers in quantitative typology and historical linguistics."
  keywords:    "phylogenetic methods, linguistic typology, genealogical signal, ACL method, BM method, glottoTrees, quantitative typology, historical linguistics"
...
# Build author array — handles single or multiple authors
# For multi-author tutorials, add orcids below as named vector
orcids <- c(
  "Martin Schweinberger" = "https://orcid.org/0000-0003-1923-9153",
  "Erich Round"         = "https://orcid.org/0000-0002-8679-4243"
)
authors_raw <- trimws(strsplit(params$author, " and ")[[1]])
author_json <- paste0(
  sapply(authors_raw, function(name) {
    orcid <- orcids[name]
    if (!is.na(orcid)) {
      paste0('    {"@type": "Person", "name": "', name,
             '", "sameAs": "', orcid, '"}')
    } else {
      paste0('    {"@type": "Person", "name": "', name, '"}')
    }
