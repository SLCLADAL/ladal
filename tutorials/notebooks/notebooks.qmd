...
![](/images/rnotebook_icon.png){ width=15% style="float:right; padding:10px" }
...
![](/images/notebook_flow.png){ width=40% style="float:right; padding:10px" }
...
![](/images/rnotebook_ui.png){ width=40% style="float:right; padding:10px" }
