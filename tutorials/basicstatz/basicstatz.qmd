...
<p style='margin-top:1em; text-align:center'>
Click [**here**](https://ladal.edu.au/content/basicstatz.Rmd)^[If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](tutorials/basicstatz/bibliography.bib) and store it in the same folder where you store the Rmd file.] to download the **entire R Notebook** for this tutorial.<br><br>
...
itdata <- base::readRDS(url("tutorials/basicstatz/data/itdata.rda", "rb"))
# data for paired t-test
ptdata <- base::readRDS(url("tutorials/basicstatz/data/ptdata.rda", "rb"))
# data for fishers exact test
fedata <- base::readRDS(url("tutorials/basicstatz/data/fedata.rda", "rb"))
# data for mann-whitney u-test
mwudata <- base::readRDS(url("tutorials/basicstatz/data/mwudata.rda", "rb"))
# data for wilcox test
uhmdata <- base::readRDS(url("tutorials/basicstatz/data/uhmdata.rda", "rb"))
# data for friedmann-test
frdata <- base::readRDS(url("tutorials/basicstatz/data/frdata.rda", "rb"))
# data for x2-test
x2data <- base::readRDS(url("tutorials/basicstatz/data/x2data.rda", "rb"))
# data for extensions of x2-test
x2edata <- base::readRDS(url("tutorials/basicstatz/data/x2edata.rda", "rb"))
# multi purpose data
mdata <- base::readRDS(url("tutorials/basicstatz/data/mdata.rda", "rb"))
```
...
# load data
tdata <- base::readRDS(url("tutorials/basicstatz/data/d03.rda", "rb")) %>%
  dplyr::rename(
    NativeSpeakers = 1,
    Learners = 2
  ) %>%
...
library(cfa)
# load data
cfadata <- base::readRDS(url("tutorials/basicstatz/data/cfd.rda", "rb"))
```
