...
<ul>
  <li>[Introduction to Quantitative Reasoning](/tutorials/introquant/introquant.html) </li>
  <li>[Basic Concepts in Quantitative Research](/tutorials/basicquant/basicquant.html) </li>
  <li>[Descriptive Statistics](/tutorials/dstats/dstats.html) </li>
