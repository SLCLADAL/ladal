...
Schweinberger, Martin. 2026. *Web Scraping with R*. Brisbane: The Language Technology and Data Analysis Laboratory (LADAL). url: https://ladal.edu.au/tutorials/scrape/scrape.html (Version 2026.03.10).
:::
...
```
@manual{schweinberger2026scrape,
  author       = {Schweinberger, Martin},
  title        = {Web Scraping with R},
  note         = {https://ladal.edu.au/tutorials/scrape/scrape.html},
  year         = {2026},
...
This tutorial was written with the assistance of **Claude** (claude.ai), a large language model created by Anthropic. Claude was used to write and structure the full tutorial on web scraping with R. Contributions include: the conceptual introduction with web scraping vs. API comparison table; the legal and ethical considerations section with the polite scraper warning callout; the HTML fundamentals section with HTML elements table, CSS selectors table, and browser developer tools guidance; the Setup section; the `rvest` workflow section with core functions table, four worked examples (Wikipedia article, HTML table, multi-page scraping, text cleaning), and the pagination and link-following section; the saving and caching section with the cache pattern; the `RSelenium` section with static vs. dynamic comparison table and interaction examples; the best practices section with the polite scraper checklist; and all 5 interactive check-in questions using the `checkdown` package. All content was reviewed and approved by Martin Schweinberger, who takes full responsibility for its accuracy.
:::
