...
params:
  ...
  url:         "https://ladal.edu.au/tutorials/network_analysis/network_analysis.html"
  institution: "The Language Technology and Data Analysis Laboratory (LADAL), The University of Queensland, Australia"
  description: "This tutorial introduces network analysis in R using igraph, covering the creation of network graphs from linguistic data, the calculation of network metrics (degree, betweenness, closeness), community detection, and the visualisation of static and interactive networks. It is aimed at researchers in corpus linguistics, discourse analysis, and digital humanities who want to model and visualise relationships between linguistic entities."
  keywords:       "network analysis, igraph, network graphs, betweenness centrality, community detection, social network analysis, linguistic networks"
  doi:         "10.5281/zenodo.19332916"
---
...
- [Loading and Saving Data in R](/tutorials/data_loading/data_loading.html) — reading files, working with paths
