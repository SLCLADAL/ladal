...
```{r prep1, echo=FALSE, eval = F, message=FALSE, warning=FALSE}
# set options
...
![](/images/doors7.png){ width=25% style="float:right; padding:10px" }

<br>

| The game in the show went like this:                  |               | 
| ----------------------------------------------------  |:-------------:|
| 1. Every participant would choose one of three doors. |  ![](/images/doors8.png){width=100% style="float:right; padding:10px" } | 
| 2. After the participant had chosen a door, Monty Hall would show the participant a goat behind one of the doors not chosen by the participant.                    | ![](/images/doors6.png){width=100% style="float:right; padding:10px" } | 
...
| ---------------------------------------------------------------------  |:-------------:|
| Initially, all three doors had a chance of 1 in 3 of hiding the prize. When you chose your door initially, you thus had a 1 in 3 chance of winning the prize while the other doors together had a 2 in 3 chance of winning. |  ![](/images/doors1.png){width=100% style="float:right; padding:10px" } | 
| When Monty Hall opens one door (he will always open a door behind which there is a goat), the 2 in 3 chance concentrate on the door that is left unopened.                           | ![](/images/doors4.png){width=100% style="float:right; padding:10px" } |


| To make it clearer: imagine Monty Hall gave you 20 doors to choose from.  |               | 
| -----------------------------------------------------------------------  |:-------------:|
| You pick one (with a 1 in 20 chance of winning) while the other 19 doors combined have a 19 out of 20 chance to win.                                                                    |  ![](/images/doors21.png){width=100% style="float:right; padding:10px" } | 
| Next, Monty Hall opens 18 out of the 19 doors you have not initially selected and asks you whether you want to switch to the one unopened door.                                        | ![](/images/doors24.png){width=100% style="float:right; padding:10px" } | 
...
[Part 1 of a video about Skinner's experiments with Pigeons](https://www.youtube.com/watch?v=QKSvu3mj-14).


![](/images/skinner.png){ width=65% style="float:center; padding:10px" }

[Part 2 of a video about Skinner's experiments with Pigeons](https://www.youtube.com/watch?v=erhmslcHvaw).
...
p3 <- ggdraw() + draw_image("images/flower1.png", scale = .8)
p4 <- ggdraw() + draw_image("images/sky.png", scale = 1.3)
plot_grid(p3, p4)
```
...
We will stop here with our introduction to quantitative reasoning. If you are interested in learning more, we highly recommend that you continue with [our tutorial on basic concepts in quantitative research](/tutorials/basicquant/basicquant.html).


# Citation & Session Info {-}

Schweinberger, Martin. 2025. *Introduction to Quantitative Reasoning*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tutorials/introquant.html (Version 2025.04.02).

```
@manual{schweinberger2025introqant,
  author = {Schweinberger, Martin},
  title = {Introduction to Quantitative Reasoning},
  note = {tutorials/introquant/introquant.html},
  year = {2025},
