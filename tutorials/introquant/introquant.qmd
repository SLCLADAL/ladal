...
plot_grid(p1, p2, labels = c("To bees, meadows rich in flowers may\nappear like a star-filled sky, \nwith individual blossoms standing\nout like stars do to humans."))  
```  
...
```{r thatcher-up, eval=T, echo=FALSE, fig.width=5, fig.height=3.5}  
