...
The entire R Notebook for the tutorial can be downloaded [**here**](tutorials/dimred/dimred.Rmd).  If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](tutorials/dimred/bibliography.bib) and store it in the same folder where you store the Rproj file. <br><br>
...
<p style='margin-top:1em; text-align:center'>
Click [**here**](https://ladal.edu.au/content/kwics.Rmd)^[If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](tutorials/dimred/bibliography.bib) and store it in the same folder where you store the Rmd file.] to download the **entire R Notebook** for this tutorial.<br><br>
...
```{r}
surveydata <- base::readRDS(url("tutorials/dimred/data/sud.rda", "rb"))
# inspect
