...
# AI Usage Statement {#ai}  
  
::: {.callout-note}  
## Use of AI in Tutorial Development  
  
This tutorial was developed with assistance from Claude (Anthropic) for:  
  
✓ Structuring content and creating callout boxes    
✓ Generating interactive checkdown exercises    
✓ Writing clear explanations of statistical concepts    
✓ Creating modern ggplot2 visualizations    
✓ Improving code documentation and comments  
  
All code examples were tested, all statistical content was verified against published sources, and all pedagogical decisions were made by the tutorial author (Martin Schweinberger).  
:::  
...
Schweinberger, Martin. 2026. *Sentiment Analysis in R*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tutorials/sentiment/sentiment.html (Version 2026.02.24).  
  
```  
@manual{schweinberger2026sentiment,  
