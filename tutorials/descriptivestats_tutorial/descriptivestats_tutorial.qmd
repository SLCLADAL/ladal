...
Schweinberger, Martin. 2026. *Descriptive Statistics with R*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tutorials/dstats/dstats.html (Version 2026.03.26).  
...
This tutorial was written with the assistance of **Claude** (claude.ai), a large language model created by Anthropic. The structure, conceptual explanations, worked examples, R code, and exercises build on an earlier tutorial by Martin Schweinberger. Claude was used to substantially revise and expand the tutorial, convert legacy HTML divs to Quarto callouts, add learning objectives and check questions, expand conceptual explanations, add the comparison section, and fix typographical errors. All content was reviewed and approved by Martin Schweinberger, who takes full responsibility for its accuracy.
:::
