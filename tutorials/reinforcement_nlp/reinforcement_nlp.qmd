...
description: "This advanced case study tutorial demonstrates the application of reinforcement learning to natural language processing tasks in R, with a focus on text summarisation, including the implementation of reward functions, the training of RL-based summarisation models, and evaluation methods. It is aimed at researchers in computational linguistics with existing knowledge of machine learning who want to explore RL-based NLP approaches."
...
params:
  ...
  url:         "https://ladal.edu.au/tutorials/reinforcement_nlp/reinforcement_nlp.html"
  institution: "The Language Technology and Data Analysis Laboratory (LADAL), The University of Queensland, Australia"
  description: "This advanced case study tutorial demonstrates the application of reinforcement learning to natural language processing tasks in R, with a focus on text summarisation, including the implementation of reward functions, the training of RL-based summarisation models, and evaluation methods. It is aimed at researchers in computational linguistics with existing knowledge of machine learning who want to explore RL-based NLP approaches."
  keywords:       "reinforcement learning, NLP, text summarisation, reward functions, machine learning, advanced NLP, computational linguistics"
  doi:         "10.5281/zenodo.19424877"
---
...
![](/images/Reinforcement.PNG){ width=60% style="float:center; padding:10px" }
...
![](/images/deeprlartsumm.PNG){ width=100% style="float:center; padding:10px" }
...
```{r impsent, depends = "summary", fig.height=6, fig.width=6, fig.cap="Position of Important Sentences in the Article"}
library(ggplot2)
...
![](/images/dlsimrl.PNG){ width=100% style="float:center; padding:10px" }
...
![](/images/NMT.PNG){ width=60% style="float:center; padding:10px" }
