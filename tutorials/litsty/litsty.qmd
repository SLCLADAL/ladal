...
Majumdar, Dattatreya and Martin Schweinberger. 2026. *Computational Literary Stylistics with R*. Brisbane: The Language Technology and Data Analysis Laboratory (LADAL). url: https://ladal.edu.au/tutorials/litsty/litsty.html (Version 2026.05.01).
:::
...
This tutorial was revised and substantially expanded with the assistance of Claude (Anthropic). All code was verified for consistency and correctness. The intellectual framing, data sources, and analytical decisions reflect the original tutorial by Majumdar and Schweinberger.
:::

Majumdar, Dattatreya and Martin Schweinberger. 2026. *Computational Literary Stylistics with R*. Brisbane: The Language Technology and Data Analysis Laboratory (LADAL). url: https://ladal.edu.au/tutorials/litsty/litsty.html (Version 2026.05.01).

```
@manual{Majumdar2026litsty,
