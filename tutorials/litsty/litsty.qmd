...
We have reached the end of this tutorial. Please feel free to explore more of our content at https://slcladal.github.io/index.html - for computational literary stylistics, especially the tutorials on [part-of-speech tagging and syntactic parsing](/tutorials/tagging/tagging.html) as well as on [lexicography with R](/tutorials/lex/lex.html) provide relevant additional information. 

# Citation & Session Info {-}

Majumdar, Dattatreya and Martin Schweinberger. 2025. *Literary Stylistics with R*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tutorials/litsty.html (Version 2025.04.02).
