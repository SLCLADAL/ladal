...
- [Regular Expressions in R](/tutorials/regular_expressions/regular_expressions.html) — pattern matching and text search
:::
...
For more on network analysis with `igraph` and `ggraph`, see the [Network Analysis tutorial](/tutorials/network_analysis/network_analysis.html).
:::
