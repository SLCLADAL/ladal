...
Schweinberger, Martin. 2026. *Automated Text Summarisation with R*. Brisbane: The Language Technology and Data Analysis Laboratory (LADAL). url: https://ladal.edu.au/tutorials/txtsum/txtsum.html (Version 2026.05.01).
:::

::: {.callout-note}
## LADAL Tool

An interactive Binder notebook that allows you to upload your own texts, apply summarisation, and download the results is available here:
...
notebook_path  <- "interactive-notebooks/notebooks/txtsumtool.ipynb"
...
Click [**here**](`r binder_url`) to open the interactive summarisation notebook.
:::
:::
...
```
@manual{schweinberger2026txtsum,
...
This tutorial was written with the assistance of **Claude** (claude.ai), a large language model created by Anthropic. Claude was used to substantially expand and restructure a shorter existing LADAL draft tutorial on text summarisation. All content was reviewed and approved by Martin Schweinberger, who takes full responsibility for its accuracy.
:::
