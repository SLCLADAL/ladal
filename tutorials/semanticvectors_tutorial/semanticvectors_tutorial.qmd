...
params:
  ...
  url:         "https://ladal.edu.au/tutorials/semanticvectors_tutorial/semanticvectors_tutorial.html"
...
- [Getting Started with R](/tutorials/intror/intror.html) — basic R syntax and RStudio
...
- [Introduction to Text Analysis](/tutorials/introta/introta.html) — corpus concepts and tokenisation
- [Introduction to Data Visualization](/tutorials/introviz/introviz.html) — `ggplot2` basics
...
# load data
vsmdata <- read.delim("tutorials/svm/data/vsmdata.txt",
                      sep = "\t", header = TRUE)
```
