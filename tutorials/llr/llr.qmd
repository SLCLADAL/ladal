...
The entire R Notebook for the tutorial can be downloaded [**here**](tutorials/llr/llr.Rmd).  If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](tutorials/llr/bibliography.bib) and store it in the same folder where you store the Rmd file. <br><br>
...
ns1 <- base::readRDS(url("tutorials/llr/data/LCorpus/ns1.rda", "rb"))
ns2 <- base::readRDS(url("tutorials/llr/data/LCorpus/ns2.rda", "rb"))
# load essays from l2 speakers
es <- base::readRDS(url("tutorials/llr/data/LCorpus/es.rda", "rb"))
de <- base::readRDS(url("tutorials/llr/data/LCorpus/de.rda", "rb"))
fr <- base::readRDS(url("tutorials/llr/data/LCorpus/fr.rda", "rb"))
it <- base::readRDS(url("tutorials/llr/data/LCorpus/it.rda", "rb"))
pl <- base::readRDS(url("tutorials/llr/data/LCorpus/pl.rda", "rb"))
ru <- base::readRDS(url("tutorials/llr/data/LCorpus/ru.rda", "rb"))
# inspect
ru %>%
  # remove header
