...
This tutorial was written with the assistance of **Claude** (claude.ai), a large language model created by Anthropic. Claude was used to substantially revise and expand an earlier tutorial by Martin Schweinberger, replacing inline references with BibTeX citation keys, converting `<div>` blocks to Quarto callouts, adding learning objectives and prerequisite callouts, expanding the distributional hypothesis section, toning down emoji, adding check questions, merging the Advanced Topics and Practical Workflow sections, and generally aligning the style with other LADAL tutorials. All references were verified independently before BibTeX entries were generated. All content was reviewed and approved by Martin Schweinberger, who takes full responsibility for its accuracy.
:::
