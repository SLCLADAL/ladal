...
This tutorial introduces lexicography with R and shows how to use R to create dictionaries and find synonyms through determining semantic similarity in R. While the initial example focuses on English, subsequent sections show how easily this approach can be generalized to languages other than English (e.g. German, French, Spanish, Italian, or Dutch).
...
Schweinberger, Martin. 2025. *Lexicography with R*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tutorials/lex.html  (Version 2025.04.02).
