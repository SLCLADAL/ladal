...
Click [**here**](`r binder_url`) to open an notebook-based tool 
<br>
...
Schweinberger, Martin. 2025. *Analyzing Collocations and N-grams in R*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tutorials/coll/coll.html (Version 2025.04.01).

```
@manual{schweinberger2025coll,
