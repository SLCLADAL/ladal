...
This tutorial shows how to perform document classification using R. The entire R markdown document for the tutorial can be downloaded [here](tutorials/atap_docclass/atap_docclass.qmd).
...
Schneider, Gerold  and Max Lauber. 2022. *Classifying American Speeches*. Brisbane: The University of Queensland. url: https://ladal.edu.au/tutorials/atap_docclass.html (Version 2022.11.15).
...
@manual{schneider2022class,
  ...
  title = {Classifying American Speeches},
  note = {tutorials/atap_docclass/atap_docclass.html},
  year = {2022},
