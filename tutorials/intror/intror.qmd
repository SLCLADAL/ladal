...
The entire R Notebook for the tutorial can be downloaded [here](https://github.com/SLCLADAL/ladal/tree/main/tutorials/intror/intror.qmd).  If you want to render the R Notebook on your computer, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](/assets/bibliography.bib) and store it in the same folder where you store the Rmd or the Rproj file. <br></p>
...
(you can check out a highly recommended introduction [here](https://uvastatlab.github.io/phdplus/intror.html)). 
...
1. Download and inspect the first 7 rows of the data set that you can find under this URL: `tutorials/intror/data/lmmdata.txt`. Can you guess what the data is about?
...
1. Use the `icebio` and determine the number of words uttered by female speakers from Northern Ireland above the age of 50.
...
The symbol `.` is one of the most powerful and most universal regular expressions as it represents (literally) any symbol or character and it thus stands for a pattern. The `*` is a regular expression that refers to the frequency of a pattern and it stands for 0 to an infinite number of instances. Thus, `.*` stands for 0 to an infinite number of any character. You can find an overview of the regular expressions that you can use in R [here](https://ladal.edu.au/tutorials/tutorials/regex/regex.html).
