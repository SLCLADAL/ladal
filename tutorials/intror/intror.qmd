...
The entire R Notebook for the tutorial can be downloaded [**here**](tutorials/intror/intror.Rmd).  If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](tutorials/intror/bibliography.bib) and store it in the same folder where you store the Rmd or the Rproj file. <br></p>
...
```{r, message=FALSE, warning=FALSE}
Trump <- base::readRDS(url("tutorials/intror/data/Trump.rda", "rb"))
# inspect data
str(Trump)
```
