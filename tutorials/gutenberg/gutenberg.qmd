...
This tutorial shows how to download and clean works from the [Project Gutenberg](https://www.gutenberg.org/) archive using R. Project Gutenberg is a data base which contains roughly 60,000 texts for which the US copyright has expired.
