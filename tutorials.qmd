...
# Welcome to the LADAL tutorials!{-}  
Ready to explore data science, statistics, and text analysis? Our tutorials guide you from beginner basics to advanced research methods—all using the free programming language R.

## Where to start?{-}  
New to programming? Begin with **R Basics** to learn the essentials. From there, explore whichever section matches your interests:
...
## Background reading{-}  
Check out **Data Science Basics** anytime for key concepts and best practices in digital research.

## Your path forward{-}  
Most tutorials build on R fundamentals, so starting with **R Basics** sets you up for success. After that, follow your curiosity—our tutorials are designed to support whatever research questions you're exploring.
