...
**Time investment:** 25-35 hours total (depending on selection)    
...
### 8. Cluster and Correspondence Analysis    
...
### 9. Introduction to Lexical Similarity    
...
### 10. Semantic Vector Space Models    
...
### 11. Dimension Reduction Methods    
...
7. Power Analysis (for study planning)  
...
```{r stats, echo=FALSE, message=FALSE, warning=FALSE}    
library(dplyr)    
...
stats <- data.frame(    
  ...
  Tutorials = c(5, 8, 3, 12, 14, 8, 5, 55),    
  `Est. Hours` = c(    
    "5-8",    
    "10-15",    
    "6-10",    
...
stats |>    
  ...
  set_caption("Overview of LADAL tutorial collection") |>    
  border_outer()    
```    
...
- **55 comprehensive tutorials** covering data science, statistics, and text analytics    
- **110-155 hours** of learning content    
