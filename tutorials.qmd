...
Welcome to LADAL tutorials. This page contains all tutorials provided by LADAL, organised in seven sections. The first section, [Data Science Basics](#data-science-basics), offers some useful background reading which introduces concepts and best practices in digital and quantitative research. The rest of the sections consist largely of more practical, follow-along tutorials. The first of these, [R Basics](#r-basics), introduces the programming language, R, which is used for all other LADAL tutorials and tools. Next is [Data Visualisation](#data-visualisation), which will show you how to create visual representations of data (such as graphs and tables) using R. The [Statistics](#statistics) section covers statistical methods with R, from simple overviews of descriptive and basic inferential statistics through to specific statistical models that may be useful when working with text and language data. The [Text Analytics](#text-analytics) section introduces a range of computational methods for analysing text, covering both the theoretical background of text analytics and practical, hands-on lessons. Next, we have a [Case Studies](#case-studies) section, which offers more specific examples of the various kinds of research you can do with the methods shown in LADAL tutorials. Finally, the [How-Tos](#how-tos) section includes some brief tutorials on accessing or converting data which you could then use to apply the methods taught in other tutorials.
 
Generally, we recommend starting with [R Basics](#r-basics), as the content covered in this section will be assumed knowledge for all subsequent sections. Once you are familiar with R and RStudio, you can move on to [Data Visualisation](#data-visualisation), [Statistics](#statistics), and/or [Text Analytics](#text-analytics), referring to the [Data Science Basics](#data-science-basics) section as needed. If you are completely new to computational methods and you’d like to explore whether LADAL will be helpful for your work, you might like to first have a quick look through [Introduction to Text Analysis](#introduction-to-text-analysis) and some of our [Case Studies](#case-studies).
...
**[Data Visualisation with R](/tutorials/dviz/dviz.html)**
...
This section covers various statistical methods and how to apply them using R. The following tutorials require some familiarity with R and RStudio, so you should be comfortable with the content in [R Basics](#r-basics) before proceeding here. Some tutorials in this section also assume familiarity with [Data Visualisation](#data-visualisation) using R, so we also recommended completing that section to get the most out of the following tutorials.
...
If you are interested in a simple introduction to statistics and quantitative analysis, we recommend first starting with Introduction to Quantitative Reasoning and Basic Concepts in Quantitative Research in the [Data Science Basics](#data-science-basics) section, followed by Descriptive Statistics and Basic Inferential Statistics here. 
