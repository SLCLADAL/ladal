...
Our tutorials guide you from beginner basics to advanced research methods!

## Where to start?{-}  
Check out **Data Science Basics** anytime for key concepts and best practices in digital research. As most tutorials build on R, starting with **R Basics** sets you up for success. After that, follow your curiosity — our tutorials are designed to support whatever research questions you're exploring:

- **Data Visualization** – Create compelling graphs and tables
- **Statistics** – Master methods for analyzing language and text data  
- **Text Analytics** – Discover computational approaches to text research
- **Case Studies** – See real-world applications in action
- **How-Tos** – Quick guides for accessing and converting data

Not sure if LADAL is right for you? Browse our **Introduction to Text Analysis** and **Case Studies** to get a feel for what's possible.

## Want a structured path?{-}  
Prefer step-by-step guidance? Check out [**LADAL Courses**](https://ladal.edu.au/courses.html), which organize our tutorials into clear learning paths. Choose a **Short Course** (5-10 tutorials) to dive into topics like corpus linguistics or text analysis, or follow a **Long Course** for a full semester's worth of material with suggestions for lecture content and relevant LADAL tutorials as well as suggested readings. 
...
**[Introduction to Data Management](/tutorials/datamanage/datamanage.html)**
...
**[Reproducibility with R](/tutorials/r_reproducibility/r_reproducibility.html)**

This tutorial introduces techniques to make your research more reproducible and transparent using R and RStudio.

# Data Visualisation

This section introduces some simple principles of data visualisation and shows you how to create visual representations of your data using R. The tutorials in this section require some familiarity with R and RStudio, so you should be comfortable with the content in [R Basics](#r-basics) before proceeding here. 
...
**[Showcase: How to create a typological map](/tutorials/leaflet/leaflet.html)**

This tutorial shows how to create typological maps in R with leaflet.

# Statistics

This section covers various statistical methods and how to apply them using R. The following tutorials require some familiarity with R and RStudio, so you should be comfortable with the content in [R Basics](#r-basics) before proceeding here. Some tutorials in this section also assume familiarity with [Data Visualisation](#data-visualisation) using R, so we also recommended completing that section to get the most out of these tutorials. If you are looking for a simple conceptual introduction to statistics and quantitative analysis, you may find it helpful to start with [Introduction to Quantitative Reasoning](tutorials/introquant/introquant.html) and [Basic Concepts in Quantitative Research](tutorials/basicquant/basicquant.html) before proceeding here.
...
**[Mixed-Effects Models](/tutorials/mixedmodel/mixedmodel.html)**
...
This section introduces text analysis using R and covers various text analytics methods. These tutorials require some familiarity with R and RStudio, so you should be comfortable with the content in the [R Basics](#r-basics) section before proceeding here. 
...
**[Finding Words in Text: Concordancing](/tutorials/kwics/kwics.html)**

This tutorial shows how to find words or phrases in text with R and how to display the results in so-called keyword-in-context (KWIC) displays (also called concordances).
...
**[Word Embeddings and Vector Semantics](/tutorials/embeddings/embeddings.html)**

This tutorial introduces word embeddings and vector semantics which are computational methods to investiagte meaning or semntics of words.


**[Automated Text Summarisation](/tutorials/txtsum/txtsum.html)**
...
This section offers some more specific examples of the kinds of research and analyses you can do with the methods taught in LADAL tutorials. These tutorials require some familiarity with R and RStudio, so you should be comfortable with the content in the [R Basics](#r-basics) section before proceeding here. 
...
**[Analysing learner language using R](/tutorials/llr/llr.html)**
...
**[Visualising and Analysing Questionnaire and Survey Data](/tutorials/surveys/surveys.html)**
...
**[Reinforcement Learning and Text Summarisation in R](/tutorials/reinfnlp/reinfnlp.html)**
...
**[Creating R Notebooks with Markdown](/tutorials/notebooks/notebooks.html)**
...
**[Creating free online ebooks with bookdown](/tutorials/bookdown/bookdown.html)**
...
**[Creating interactive Jupyter notebooks](/tutorials/jupyter/jupyter.html)**
...
**[Downloading Texts from Project Gutenberg](/tutorials/gutenberg/gutenberg.html)**
