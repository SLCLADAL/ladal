...
![](/images/slc.png){ width=45% style="float:right; padding:10px" }
...
![](/images/martin_c.png){ width=30% style="float:left; padding:10px" }
...
![](/images/michael_c.png){ width=30% style="float:left; padding:10px" }
...
[Laurence Anthony](https://scholar.google.com/citations?user=DS8jIxUAAAAJ&hl=en)


![](/images/laurence_anthony.jpg){ width=25% style="float:left; padding:10px; border-radius:50%;" }
...
![](/images/ben_c.png){ width=25% style="float:left; padding:10px" } 
...
![](/images/stefan_c.png){ width=25% style="float:left; padding:10px" }
...
![](/images/AndreasNiekler.png){ width=25% style="float:left; padding:10px" }
...
![](/images/gregor_c.png){ width=25% style="float:left; padding:10px" }
...
![](/images/erich_c.png){ width=25% style="float:left; padding:10px" }
...
![](/images/stephane_c.png){ width=25% style="float:left; padding:10px" }
...
![](/images/joe_c.png){ width=25% style="float:left; padding:10px" }
...
[Sam Hames](https://languages-cultures.uq.edu.au/profile/8379/sam-hames)

![](/images/sam_hames.jpeg){ width=25% style="float:left; padding:10px" }
...
![](/images/slc.png){ width=30% style="float:left; padding:10px" }
...
![](/images/ttclogo.png){ width=20% style="float:left; padding:10px" }
...
![](/images/scl2.png){ width=20% style="float:left; padding:10px" }
...
![](/images/varieng2.png){ width=30% style="float:left; padding:10px" }
...
![](/images/acqvalab.png){ width=30% style="float:left; padding:10px" }
...
![](/images/Logo_HBI.jpg){ width=30% style="float:left; padding:10px" }
